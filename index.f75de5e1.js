...
document.addEventListener("click", (e)=>{
    ...
    if (x < 0) x = 0;
    if (y < 0) y = 0;
    if (x + spider.offsetWidth > wall.clientWidth) x = wall.clientWidth - spider.offsetWidth;
    if (y + spider.offsetHeight > wall.clientHeight) y = wall.clientHeight - spider.offsetHeight;
